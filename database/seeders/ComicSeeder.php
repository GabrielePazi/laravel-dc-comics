...
class ComicSeeder extends Seeder
{
    ...
    {
        foreach ($this->rawComics as $rawComic) {
            $comic = new Comic();

            $comic->title = $rawComic["title"];
            $comic->description = $rawComic["description"];
            $comic->thumb = $rawComic["thumb"];
            $comic->price = str_replace("$", "", $rawComic["price"]);
            $comic->series = $rawComic["series"];
            $comic->sale_date = $rawComic["sale_date"];
            $comic->type = $rawComic["type"];
            $comic->artists = json_encode($rawComic["artists"]);
            $comic->writers = json_encode($rawComic["writers"]);
